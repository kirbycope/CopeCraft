...
execute unless entity @e[tag=invisible_minecart] at @s run summon minecraft:chest_minecart ~ ~1.2 ~ {Silent:1b,Tags:["invisible_minecart"],CustomDisplayTile:1b,CustomName:'{"text":"Menu"}',DisplayState:{Name:"minecraft:air"}}
