...
execute unless entity @e[nbt={Tags:["menu-chest"]}] run summon minecraft:chest_minecart -42 320 -42 {CustomName:'"Menu Chest"',CustomDisplayTile:1b,DisplayState:{Name:"minecraft:air"},Silent:1,Tags:["menu-chest"]}
