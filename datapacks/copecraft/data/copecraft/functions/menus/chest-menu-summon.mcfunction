...
execute as @e[tag=menu_chest] run data merge entity @s[tag=menu_chest] {CustomDisplayTile:1,DisplayState:{Name:"minecraft:command_block",Properties:{conditional:"true",facing:"up"}},DisplayOffset:4}
