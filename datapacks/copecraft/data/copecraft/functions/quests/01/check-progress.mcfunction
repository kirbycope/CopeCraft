...
execute if entity @a[scores={copecraft-quest-objective=1,copecraft-wheat-seeds-picked-up=1}] run bossbar set copecraft:bossbar-q1o1 name [{"text":"Objective: "},{"text":"Find Wheat Seeds ","color":"yellow"},{"text":"(1/3)"}]
# (2/3)
...
execute if entity @a[scores={copecraft-quest-objective=1,copecraft-wheat-seeds-picked-up=2}] run bossbar set copecraft:bossbar-q1o1 name [{"text":"Objective: "},{"text":"Find Wheat Seeds ","color":"yellow"},{"text":"(2/3)"}]
# (3/3)
...
execute if entity @a[scores={copecraft-quest-objective=2,copecraft-wheat-seeds-used=1}] run bossbar set copecraft:bossbar-q1o2 name [{"text":"Objective: "},{"text":"Plant Wheat Seeds ","color":"yellow"},{"text":"(1/3)"}]
# (2/3)
