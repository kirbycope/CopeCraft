...
bossbar remove copecraft:bossbar-q5o1
...
team modify q5o1 suffix {"text":". Harvest Wheat", "color": "green"}
team join q5o1 §a1

# [Bossbar] Objective Tracker - "Bake Bread"
bossbar add copecraft:bossbar-q5o2 [{"text":"Objective: "},{"text":"Bake Bread","color":"yellow"},{"text":" (0/1)"}]
