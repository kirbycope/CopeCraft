...
execute if entity @a[scores={copecraft-quest-objective=1,copecraft-wheat-mined=1}] run bossbar set copecraft:bossbar-q5o1 name [{"text":"Objective: "},{"text":"Harvest Wheat","color":"yellow"},{"text":" (1/3)"}]
# (2/3)
...
execute if entity @a[scores={copecraft-quest-objective=1,copecraft-wheat-mined=2}] run bossbar set copecraft:bossbar-q5o1 name [{"text":"Objective: "},{"text":"Harvest Wheat","color":"yellow"},{"text":" (2/3)"}]
# (3/3)
